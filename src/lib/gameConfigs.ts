...
export const gameConfigs: GameConfig[] = [
  ...
  { id: 'fast-math', title: 'رياضيات سريعة', description: 'حل العمليات الحسابية بسرعة', icon: '🔢', mode: 'both', timePerQuestion: 10, questionsPerRound: 20, category: 'تعليم' },
  ...
  { id: 'jordanian-food', title: 'أكلات أردنية', description: 'أسئلة عن الأكلات الشعبية الأردنية', icon: '🍽️', mode: 'solo', timePerQuestion: 12, questionsPerRound: 20, category: 'طعام' },
